...
This algorithm is compared to the current \ac{L1} jet algorithm.% and the `best' possible algorithm, which is taken to be the \ac{PF} algorithm with towers used as inputs.
