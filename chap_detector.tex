...
As discussed in the previous sections, \ac{CMS} is hermetic, has coverage up to $|\eta| = 5$ and excellent particle reconstruction; a very complete picture of each event is available. 
