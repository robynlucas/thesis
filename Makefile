...
mythesis.pdf: mythesis.tex mythesis.cls intro.tex chap_theory.tex chap_detector.tex chap_l1jets.tex chap_compSUSY.tex chap_compSUSYresults.tex chap_parkedData.tex frontmatter.tex appendices.tex
	@rm -f $(EXTRASTYS)
